...
// Initialize dashboard and populate metadata Information
...
//Constract and set up for the bar chart
//build and trace for bubble chart
function Plots(id) {
    d3.json(url).then(function (data) {
        let sampleData = data;
 ...
 //Updates to dashboard when new sample is selected
function optionChanged(id) {
    Plots(id);
    panelInfo(id);
};

//check Subject Dropdown and initial function
function init() {
